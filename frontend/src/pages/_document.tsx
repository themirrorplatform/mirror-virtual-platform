...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta name="description" content="The Mirror Virtual Platform - A social media platform built on reflection, not engagement." />
        <link rel="icon" href="/favicon.ico" />
        
        {/* Google Fonts - Work Sans, Roboto, Lexend Deca, Inter */}
