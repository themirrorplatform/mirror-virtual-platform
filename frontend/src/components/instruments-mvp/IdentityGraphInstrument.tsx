            ...
            <div className="flex items-center justify-between">
              ...
              <label className="relative inline-block w-12 h-6">
                <input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => onToggleLearning(selectedNode.id, e.target.checked)}
      ...
      >
        ...
        <div className="p-6 border-b border-[var(--color-border-subtle)]">
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              value={filterOrigin}
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFilterOrigin(e.target.value)}
            ...
            <select
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setFilterLearning(e.target.value)}
              className="px-3 py-2 rounded-lg bg-[var(--color-surface-emphasis)] border border-[var(--color-border-subtle)] text-sm text-[var(--color-text-primary)] focus:outline-none focus:border-[var(--color-accent-gold)]"
            >
