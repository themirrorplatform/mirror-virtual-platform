                  ...
                  >
                    <label className="block mb-2">
                      ...
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setEncryptionPassword(e.target.value)}
              ...
              <div className="p-4 rounded-2xl bg-[var(--color-warning)]/10 border border-[var(--color-warning)]/30">
                ...
                <label className="flex items-start gap-3 mt-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => setUnderstoodImplications(e.target.checked)}
                    className="mt-0.5"
                  />
