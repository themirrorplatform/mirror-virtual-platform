...
import { Shield, Ban, Check, FileText, AlertCircle, X } from 'lucide-react';
    ...
    >
      ...
      >
        ...
        <div className="p-6 border-b border-[var(--color-border-subtle)] flex items-center justify-between flex-shrink-0">
          <div>
            <h2 className="text-xl font-semibold mb-1 text-[var(--color-text-primary)]">Speech Contract</h2>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex items-center gap-4 p-4 rounded-xl bg-[var(--color-surface-card)] border border-[var(--color-border-subtle)]">
            ...
            <div>
              ...
              <div className="capitalize text-[var(--color-text-primary)]">{layer}</div>
            </div>
            {fork && (
              <>
                ...
                <div>
                  ...
                  <div className="text-[var(--color-text-primary)]">{fork}</div>
                </div>
              </>
            )}
          </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">Allowed</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">Forbidden</h3>
            </div>
            <div className="space-y-2">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">Data Routing</h3>
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-[var(--color-text-primary)]">Bound Constitutions</h3>
            </div>
            <div className="space-y-2">
