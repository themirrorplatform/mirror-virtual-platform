          ...
          <div className="flex items-start justify-between">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={autoTheme}
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => onAutoThemeChange(e.target.checked)}
        ...
        <div className="space-y-4">
          ...
          <label className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-surface-hover)] cursor-pointer hover:bg-[var(--color-accent-blue)]/10">
            <input
              ...
              onChange={(e: React.ChangeEvent<HTMLInputElement>) => onReducedMotionChange(e.target.checked)}
