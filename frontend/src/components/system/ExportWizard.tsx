      ...
      <div className="space-y-3">
        <label className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-surface-hover)] cursor-pointer">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setConfig({ ...config, includePrivate: e.target.checked })}
            className="mt-1 w-5 h-5 rounded border-[var(--color-border-subtle)]"
          />
          <div>
        ...
        <label className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-surface-hover)] cursor-pointer">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setConfig({ ...config, includeMetadata: e.target.checked })}
            className="mt-1 w-5 h-5 rounded border-[var(--color-border-subtle)]"
          />
          <div>
        ...
        <label className="flex items-start gap-3 p-3 rounded-lg bg-[var(--color-surface-hover)] cursor-pointer">
          <input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => setConfig({ ...config, includeAttachments: e.target.checked })}
            className="mt-1 w-5 h-5 rounded border-[var(--color-border-subtle)]"
          />
          <div>
