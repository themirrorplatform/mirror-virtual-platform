              ...
              >
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={config.title}
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setConfig({ ...config, title: e.target.value })}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setConfig({ ...config, description: e.target.value })}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setConfig({ ...config, reflectiveCondition: e.target.value })}
