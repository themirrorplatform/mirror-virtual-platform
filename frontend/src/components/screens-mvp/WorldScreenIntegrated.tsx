        ...
        <div className="max-w-3xl mx-auto px-6 py-4 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <select
                value={sortBy}
                onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setSortBy(e.target.value as 'recent' | 'witnessed')}
          ...
          <AnimatePresence>
            {showResponse && (
              ...
              >
                ...
                <textarea
                  value={responseText}
                  onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setResponseText(e.target.value)}
                  placeholder="..."
