...
export default function App() {
  ...
  // Pending action after entry flow
  ...
  useGlobalKeyboard({
    ...
    openCrisis: () => handleSelectInstrument('crisis'),
    closeAllInstruments: () => setActiveInstruments([]),
  ...
  return (
    <ErrorBoundary>
      ...
      {!isInitialized && !initError && (
        <LoadingState message="Opening reflection space..." />
      )}
      ...
      {/* Main app - only render when initialized */}
      {isInitialized && !initError && (
      <MirrorField
      ...
      >
        ...
        {/* Top Bar - Navigation */}
        <nav 
          className="flex items-center justify-between px-6 py-4 border-b border-[var(--color-border-subtle)]"
          role="navigation"
          aria-label="Main navigation"
        >
          <div className="flex items-center">
            <MessageSquare size={24} className="mr-2" aria-hidden="true" />
            <h1 className="text-xl">The Mirror</h1>
          </div>
          <div className="flex gap-2">
            <button
              className="p-2 rounded-full bg-[var(--color-accent-gold)]/10 hover:bg-[var(--color-accent-gold)]/20 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-gold)]"
            ...
            <button
              className="p-2 rounded-full bg-[var(--color-accent-gold)]/10 hover:bg-[var(--color-accent-gold)]/20 transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--color-accent-gold)]"
              onClick={() => handleSelectInstrument('crisis')}
              aria-label="Open crisis support (⌘⇧C)"
              title="Open crisis support (⌘⇧C)"
            >
